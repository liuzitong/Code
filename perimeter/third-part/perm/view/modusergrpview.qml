...
IcPageBase {   // this is the wrapped Popup element in ui_qml_control
    id: idModUserGrpView; pageName: "ModUserGrp";
    ...
    ColumnLayout { anchors.fill: parent; spacing: 4;
        ...
        Rectangle { Layout.fillWidth: true; Layout.preferredHeight: 84; Layout.alignment: Qt.AlignHCenter | Qt.AlignTop; color: "#333e44";
            ...
            Text { anchors.centerIn: parent; text: qsTr("Modify User Group"); font.pixelSize: 24; color: "#FAFAFA"; }
        }
        ...
        ColumnLayout { Layout.fillWidth: true; Layout.fillHeight: true; spacing: 30;
            ...
            Item { Layout.fillWidth: true; Layout.preferredHeight: 38; Layout.alignment: Qt.AlignHCenter;
                ...
                TextField { id: idUserGrpNameEdit; objectName: "UserInputItem.TextField"; anchors.left: parent.left; anchors.leftMargin: editItemWidth; width: editItemWidth; height: 38; placeholderText: qsTr("Please enter user group name"); font.pixelSize: 16;  selectByMouse: true; selectionColor: "lightblue";
                    background: Rectangle { implicitWidth: parent.width; implicitHeight: 38; border.color: "#6E6E6E"; border.width: 1; color: "#FAFAFA"; radius: 4; }
                }
            }
            ...
            Item { Layout.fillWidth: true; Layout.preferredHeight: 100; Layout.alignment: Qt.AlignHCenter;
                ...
                TextArea { id: idMemoEdit; objectName: "UserInputItem.TextArea"; anchors.left: parent.left; anchors.leftMargin: editItemWidth; width: editItemWidth; height: 100; placeholderText: qsTr("Please enter memo information"); font.pixelSize: 16;  selectByMouse: true; selectionColor: "lightblue";
                    background: Rectangle { implicitWidth: parent.width; implicitHeight: 100; border.color: "#6E6E6E"; border.width: 1; color: "#FAFAFA"; radius: 4; }
                }
            }
        ...
        Rectangle { Layout.fillWidth: true; Layout.preferredHeight: 60; Layout.alignment: Qt.AlignHCenter | Qt.AlignBottom; color: "#333e44";
            ...
            RowLayout { anchors.fill: parent; anchors.leftMargin: 5; anchors.rightMargin: 5;
                ...
                Button { id: idSaveBtn; Layout.preferredWidth: 100; Layout.preferredHeight: 38; Layout.alignment: Qt.AlignRight | Qt.AlignVCenter; text: qsTr("Save"); focusPolicy: Qt.NoFocus;
                    background: Rectangle { implicitWidth: 128; implicitHeight: 38; color: idSaveBtn.down ? "#bdc0c6" : "#E0E0E0"; opacity: enabled ? 1 : 0.3; radius: 4; }
    ...
    QtObject {
        id: idPriv;
        property var mod_user_grp_vm: value
        ...
        function init( )
        {
            mod_user_grp_vm = IcUiQmlApi.appCtrl.objMgr.attachObj( "FcPerm::ModUserGrpVm", true );
            initUI();
            doOnline(); idModUserGrpView.pageInit();
        }
        ...
        function deinit( )
        {
            ...
            doOffline( );
            IcUiQmlApi.appCtrl.objMgr.detachObj( "FcPerm::ModUserGrpVm", mod_user_grp_vm );
            idModUserGrpView.pageDeinit();
        }

        function doOffline( )
        {
            mod_user_grp_vm.showUserGrpPermListView.disconnect( onShowUserGrpPermListView );
        ...
        function doOnline( )
        {
            mod_user_grp_vm.showUserGrpPermListView.connect( onShowUserGrpPermListView );
        ...
        function backView( )
        {
            idModUserGrpView.request( "Back", { } );
        }

        function turnUserLoginView( )
        {
            idModUserGrpView.request( "UserLoginView", { } );
        }

        function editUserGrpPerm( )
        {
            IcUiQmlApi.postMetaCall( idPriv.mod_user_grp_vm, "editUserGrpPerm" );
        }

        function initUI()
        {
            idUserGrpNameEdit.text = Qt.binding( function() { return idPriv.mod_user_grp_vm.editUserGrpInfo.groupName; } );
            idMemoEdit.text        = Qt.binding( function() { return idPriv.mod_user_grp_vm.editUserGrpInfo.groupMemo; } );
        ...
        function save( )
        {
            ...
            mod_user_grp_vm.grpInfo = data;
            IcUiQmlApi.postMetaCall( mod_user_grp_vm, "save" );
        }
        ...
        function onShowUserGrpPermListView( )
        {
            ...
            var cfm_diag = cmpt.createObject( idModUserGrpView );

            // c) setup information about this confirm object
            cfm_diag.contentWidth = idModUserGrpView.width; cfm_diag.contentHeight = idModUserGrpView.height;
