...
ModalPopupDialog {   // this is the wrapped Popup element in ui_qml_control
    ...
    contentItem: Rectangle {
        ...
        Rectangle { anchors.centerIn: parent; implicitWidth: 480; implicitHeight: 500; color: "#FAFAFA"; border.color: "#6E6E6E";
            ...
            ColumnLayout { anchors.fill: parent; anchors.margins: 20; spacing: 20;
                ...
                ListView { id: idGroupList; Layout.preferredWidth: 400; Layout.fillHeight: true; Layout.alignment: Qt.AlignHCenter; clip: true; spacing: 20;
                    ...
                    delegate: Item { width: 400; height: 36;
                        ...
                        CheckBox { id: idGrpChk; anchors.left: parent.left; anchors.leftMargin: 100; implicitHeight: 36; enabled: false; checked: true; text: modelData;
                            indicator: Image { width: 36; height: 36; source: idGrpChk.checked ? "qrc:/images/check_box_yes.svg" : "qrc:/images/check_box_no.svg"; opacity: idGrpChk.enabled ? 1 : 0.4; }
                ...
                Button { id: idOkBtn; Layout.preferredWidth: 120; Layout.preferredHeight: 50; Layout.alignment: Qt.AlignBottom | Qt.AlignHCenter; text: qsTr("OK"); focusPolicy: Qt.NoFocus;
                    background: Rectangle { implicitWidth: 128; implicitHeight: 80; color: enabled ? (idOkBtn.down ? "#bdc0c6" : "#E0E0E0") : "#60E0E0E0"; radius: 4; }
    ...
    QtObject {
        ...
        function init( )
        {
            ...
            idGroupList.model = user_mgr_vm.specUserGrpListInfo.groupList;
        }
