...
IcPageBase {   // this is the wrapped Popup element in ui_qml_control
    id: idModUserView; pageName: "ModUser";
    ...
    ColumnLayout { anchors.fill: parent; spacing: 4;
        ...
        Rectangle { Layout.fillWidth: true; Layout.preferredHeight: 84; Layout.alignment: Qt.AlignHCenter | Qt.AlignTop; color: "#333e44";
            ...
            Text { anchors.centerIn: parent; text: qsTr("Modify User"); font.pixelSize: 24; color: "#FAFAFA"; }
        }

        ColumnLayout { Layout.fillWidth: true; Layout.fillHeight: true; spacing: 30;

            Item { Layout.preferredWidth: parent.width; Layout.preferredHeight: 38; Layout.alignment: Qt.AlignHCenter;
            ...
            Item { Layout.preferredWidth: parent.width; Layout.preferredHeight: 38; Layout.alignment: Qt.AlignHCenter;
                ...
                TextField { id: idPwdEdit; objectName: "UserInputItem.TextField"; anchors.left: parent.left; anchors.leftMargin: editItemWidth; width: editItemWidth; height: 38; placeholderText: qsTr("6-20 digits or letters"); font.pixelSize: 16;  echoMode: TextInput.Password; selectByMouse: true; selectionColor: "lightblue";
            ...
            Item { Layout.preferredWidth: parent.width; Layout.preferredHeight: 38; Layout.alignment: Qt.AlignHCenter;
                ...
                TextField { id: idConfirmPwdEdit; objectName: "UserInputItem.TextField"; anchors.left: parent.left; anchors.leftMargin: editItemWidth; width: editItemWidth; height: 38; placeholderText: qsTr("Please enter password again"); font.pixelSize: 16;  echoMode: TextInput.Password; selectByMouse: true; selectionColor: "lightblue";
                    validator: RegExpValidator { regExp: /[0-9a-zA-Z]{6,20}/ }
                    background: Rectangle { implicitWidth: parent.width; implicitHeight: 38; border.color: "#6E6E6E"; border.width: 1; color: "#FAFAFA"; radius: 5; }
                }
            }

            Item { Layout.preferredWidth: parent.width; Layout.preferredHeight: 100; Layout.alignment: Qt.AlignHCenter;
            ...
            Item { Layout.preferredWidth: parent.width; Layout.preferredHeight: 38; Layout.alignment: Qt.AlignHCenter;
                ...
                Button { id: idUserGrpBtn; anchors.left: parent.left; anchors.leftMargin: editItemWidth; width: 120; height: 38; text: qsTr("Edit"); focusPolicy: Qt.NoFocus;
                    background: Rectangle { implicitWidth: 120; implicitHeight: 38; color: idUserGrpBtn.down ? "#bdc0c6" : "#E0E0E0"; border.color: "#6E6E6E"; border.width: 1; radius: 4; }
            ...
            Item { Layout.preferredWidth: parent.width; Layout.preferredHeight: 38; Layout.alignment: Qt.AlignHCenter;
                ...
                Button { id: idUserPermBtn; anchors.left: parent.left; anchors.leftMargin: editItemWidth; width: 120; height: 38; text: qsTr("Edit"); focusPolicy: Qt.NoFocus;
                    background: Rectangle { implicitWidth: 120; implicitHeight: 38; color: idUserPermBtn.down ? "#bdc0c6" : "#E0E0E0"; border.color: "#6E6E6E"; border.width: 1; radius: 4; }
        ...
        Rectangle { Layout.fillWidth: true; Layout.preferredHeight: 60; Layout.alignment: Qt.AlignHCenter | Qt.AlignBottom; color: "#333e44";
            ...
            RowLayout { anchors.fill: parent; anchors.leftMargin: 5; anchors.rightMargin: 5;
                ...
                Button { id: idBackBtn; Layout.preferredWidth: 100; Layout.preferredHeight: 38; Layout.alignment: Qt.AlignLeft | Qt.AlignVCenter; text: qsTr("Back"); focusPolicy: Qt.NoFocus;
                    background: Rectangle { implicitWidth: 128; implicitHeight: 38; color: idBackBtn.down ? "#bdc0c6" : "#E0E0E0"; opacity: enabled ? 1 : 0.3; radius: 4; }
                ...
                Button { id: idSaveBtn; Layout.preferredWidth: 100; Layout.preferredHeight: 38; Layout.alignment: Qt.AlignRight | Qt.AlignVCenter; text: qsTr("Save"); focusPolicy: Qt.NoFocus;
                    background: Rectangle { implicitWidth: 128; implicitHeight: 80; color: idSaveBtn.down ? "#bdc0c6" : "#E0E0E0"; opacity: enabled ? 1 : 0.3; radius: 4; }
                ...
                Button { id: idQuitBtn; Layout.preferredWidth: 100; Layout.preferredHeight: 38; Layout.alignment: Qt.AlignRight | Qt.AlignVCenter; text: qsTr("Quit"); focusPolicy: Qt.NoFocus;
                    background: Rectangle { implicitWidth: 128; implicitHeight: 38; color: idQuitBtn.down ? "#bdc0c6" : "#E0E0E0"; opacity: enabled ? 1 : 0.3; radius: 4; }
    ...
    QtObject {
        ...
        function init( )
        {
            mod_user_vm       = IcUiQmlApi.appCtrl.objMgr.attachObj( "FcPerm::ModUserVm", true );
            initUI();
            doOnline(); idModUserView.pageInit();
        }
        ...
        {
            doOffline( );
            IcUiQmlApi.appCtrl.objMgr.detachObj( "FcPerm::ModUserVm", mod_user_vm );
            idModUserView.pageDeinit();
        }

        function doOffline( )
        {
            mod_user_vm.showUserGrpListView.disconnect( onShowUserGroupListView );
            mod_user_vm.showUserPermListView.disconnect( onShowUserPermListView );
        ...
        function doOnline( )
        {
            mod_user_vm.showUserGrpListView.connect( onShowUserGroupListView );
            mod_user_vm.showUserPermListView.connect( onShowUserPermListView );
        ...
        function backView( )
        {
            idModUserView.request( "Back", { } );
        }

        function turnUserLoginView( )
        {
            idModUserView.request( "UserLoginView", { } );
        }

        function editUserGroup( )
        {
            IcUiQmlApi.postMetaCall( idPriv.mod_user_vm, "editUserGroup" );
        }

        function editUserPerm( )
        {
            IcUiQmlApi.postMetaCall( idPriv.mod_user_vm, "editUserPerm" );
        }

        function initUI()
        {
            idUserNameEdit.text = Qt.binding( function() { return idPriv.mod_user_vm.editUserInfo.userName; } );
            idPwdEdit.text      = Qt.binding( function() { return idPriv.mod_user_vm.editUserInfo.userPwd; } );
            idConfirmPwdEdit.text = Qt.binding( function() { return idPriv.mod_user_vm.editUserInfo.userPwd; } );
            idMemoEdit.text     = Qt.binding( function() { return idPriv.mod_user_vm.editUserInfo.userMemo; } );
        ...
        function save( )
        {
            ...
            mod_user_vm.userInfo = data;
            IcUiQmlApi.postMetaCall( mod_user_vm, "save" );
        }
        ...
        function onShowUserGroupListView( )
        {
            ...
            var cfm_diag = cmpt.createObject( idModUserView );

            // c) setup information about this confirm object
            cfm_diag.contentWidth = idModUserView.width; cfm_diag.contentHeight = idModUserView.height;
