...
public:
    ...
    Q_INVOKABLE void getProgressBaseLineReport(QString diagnosis,bool uploadDicom=false);
    Q_INVOKABLE void getThreeFollowUpsReport(int index,QString diagnosis,bool uploadDicom=false);
    Q_INVOKABLE void getSingleProgressReport(int index,QString diagnosis,bool uploadDicom=false);
