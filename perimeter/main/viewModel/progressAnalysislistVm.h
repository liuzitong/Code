...
public:
    ...
    Q_INVOKABLE void getProgressBaseLineReport(QString diagnosis,bool uploadDicom,bool useDigitalSignature,int UID);
    Q_INVOKABLE void getThreeFollowUpsReport(int index,QString diagnosis,bool uploadDicom,bool useDigitalSignature,int UID);
    Q_INVOKABLE void getSingleProgressReport(int index,QString diagnosis,bool uploadDicom,bool useDigitalSignature,int UID);
