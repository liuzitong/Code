...
public:
    ...
    Q_INVOKABLE void showReport(int report,bool uploadDicom,bool useDigitalSignature,int uid);
...
public:
    ...
    Q_INVOKABLE void showReport(int report,QString diagnosis,bool uploadDicom,bool useDigitalSignature,int uid);
