...
public:
    ...
    int getCheckState(){return m_checkState;} void setCheckState(int value){m_checkState=value;std::cout<<"checkState:"<<m_checkState<<std::endl;emit checkStateChanged();}Q_SIGNAL void checkStateChanged();
