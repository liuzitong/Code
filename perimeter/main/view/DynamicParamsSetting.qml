                ...
                Column{
                        ...
                        Rectangle{
                            ...
                            Row{
                                ...
                                Column{
                                   ...
                                   Item{
                                       width: parent.width; height:parent.parent.rowHeight;
                                       CusText{text:lt+qsTr("Eye move remind"); anchors.left: parent.left; anchors.leftMargin: 0;width: parent.width*0.4;horizontalAlignment: Text.AlignLeft;font.pointSize: fontPointSize;}
                                       CusComboBox{
                                           width: parent.width*0.5; anchors.right: parent.right;model:[lt+qsTr("Only remind"),lt+qsTr("Remind and pause")];
                    ...
                    Item {
                        ...
                        Flow{
                            ...
                            anchors.verticalCenter: parent.verticalCenter
                            CusButton{text:lt+qsTr("Cancel");onClicked: {idPopup.close();currentProgramChanged();}}
