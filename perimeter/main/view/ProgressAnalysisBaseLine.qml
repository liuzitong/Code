            ...
            Column{
                ...
                Repeater{
                    ...
                    model: [
                        ...
                        {name:lt+qsTr("MD"),param:progressAnalysisListVm.getData(0,"md").toFixed(2)+(progressAnalysisListVm.getData(0,"p_md").toFixed(2)<10?(" (<"+progressAnalysisListVm.getData(0,"p_md").toFixed(2)+"%)"):"")},
                        {name:lt+qsTr("PSD"),param:progressAnalysisListVm.getData(0,"psd").toFixed(2)+(progressAnalysisListVm.getData(0,"p_psd").toFixed(2)<10?(" (<"+progressAnalysisListVm.getData(0,"p_psd").toFixed(2)+"%)"):"")},
            ...
            Column{
                ...
                Repeater{
                    ...
                    model: [
                        ...
                        {name:lt+qsTr("MD"),param:progressAnalysisListVm.getData(1,"md").toFixed(2)+(progressAnalysisListVm.getData(1,"p_md").toFixed(2)<10?(" (<"+progressAnalysisListVm.getData(0,"p_md").toFixed(2)+"%)"):"")},
                        {name:lt+qsTr("PSD"),param:progressAnalysisListVm.getData(1,"psd").toFixed(2)+(progressAnalysisListVm.getData(1,"p_psd").toFixed(2)<10?(" (<"+progressAnalysisListVm.getData(0,"p_psd").toFixed(2)+"%)"):"")},
