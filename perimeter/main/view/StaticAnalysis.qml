    ...
    //                        CusText{text:"固视监测";  horizontalAlignment: Text.AlignLeft;height:textHeight;width: parent.width;}
                    ...
                    Column{width:parent.width;height: parent.height*0.12;spacing: textHeight*0.5;
                        Repeater{
                            ...
                            property var strategy: [lt+qsTr("Full threshold"),lt+qsTr("Fast threshold"),lt+qsTr("Smart interactive"),lt+qsTr("Fast interactive"),lt+qsTr("Two Zone"),lt+qsTr("Three Zone"),lt+qsTr("Quantify defects"),lt+qsTr("Single stimulus")]
                            model: [
