                                    ...
                                    Item{anchors.fill: parent;anchors.margins: parent.height*0.1;
                                        Column{anchors.fill: parent;spacing: 0.175*height;
                                            Row{width:parent.width;height: parent.height*0.65/3;spacing: width*0.05;
                                                ...
                                                LineEdit {
                                                    text:currentProgram==null?"":currentProgram.name; width: parent.width*0.50;enabled: false;
                                            ...
                                            Row{width:parent.width;height: parent.height*0.65/3;spacing: width*0.05;
                                                ...
                                                LineEdit{
                                                    ...
                                                    width: parent.width*0.50;enabled: false;
                                                }
                                            }
                                            Row{width:parent.width;height: parent.height*0.65/3;spacing: width*0.05;
...
//                                                    property var totalDots: currentProgram===null?0:currentProgram.data.dots.length/*+centerDot*/;
                                                    text:checkedDots+"/"+totalDots;width: parent.width*0.5;enabled: false;
                                                }
                                            }
                                            Row{width:parent.width;height: parent.height*1/3;spacing: width*0.05;
                                                ...
                                                LineEdit{
                                                    ...
                                                    text:Math.floor(timeSpan/60)+":"+timeSpan%60;width: parent.width*0.5;enabled: false;}
                                            }
                                        }
                                    }
                                }
                                    ...
                                    Item{ anchors.fill: parent;anchors.margins: parent.height*0.1;
                                        Column{anchors.fill: parent;spacing: 0.125*height;
                                            ...
                                            Row{id: row;width:parent.width;height: parent.height*0.75/3;spacing: width*0.05;
                                                ...
                                                CusText{text:lt+qsTr("Eye move remind"); horizontalAlignment: Text.AlignLeft;width: parent.width*0.50;font.pointSize: fontPointSize;}
...
//                                                Component.onCompleted: {root.currentProgramChanged.connect(function(){if(currentProgram.type===2){deviationCheckBox.checked=false;deviationCheckBox.enabled=false;}else {deviationCheckBox.enabled=true;deviationCheckBox.checked=false;}});}
                    ...
                    Rectangle{width: parent.width*0.5;height: parent.height;color:backGroundColorCheckPanel;
                        ...
                        Rectangle{
                            property string tip:checkDisplay.tip==""?((checkSvc.envLightAlarm?qsTr("Environment light is too strong."):"")+(checkSvc.chinDistAlarm?qsTr("Put your chin more forward."):"")):checkDisplay.tip;
                            width: parent.width;height: 20; anchors.bottom: parent.bottom;color: "white";opacity: 0.5;visible:tip!="";
                            CusText {anchors.fill: parent;verticalAlignment: Text.AlignVCenter;text:parent.tip; wrapMode: Text.WordWrap;color:"red"}
