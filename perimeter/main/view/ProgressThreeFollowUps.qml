                        ...
                        Column{
                            ...
                            Repeater{
                                ...
                                model: [
                                    ...
                                    {name:lt+qsTr("MD"),param:progressAnalysisListVm.getData(index+modelData.index_list,"md").toFixed(2)+(progressAnalysisListVm.getData(index+modelData.index_list,"p_md").toFixed(2)<10?(" (<"+progressAnalysisListVm.getData(index+modelData.index_list,"p_md").toFixed(2)+"%)"):"")},
                                    {name:lt+qsTr("PSD"),param:progressAnalysisListVm.getData(index+modelData.index_list,"psd").toFixed(2)+(progressAnalysisListVm.getData(index+modelData.index_list,"p_psd").toFixed(2)<10?(" (<"+progressAnalysisListVm.getData(index+modelData.index_list,"p_psd").toFixed(2)+"%)"):"")},
